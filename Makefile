...
SRC_DIR     = ./src/
OBJ_DIR     = ./obj/
SRC_FILES   =	Utils.cpp LocationTokens.cpp Definitions/Location.cpp Definitions/Request.cpp Definitions/ConfigParser.cpp Definitions/Server.cpp \
				Definitions/Client.cpp Definitions/Signal.cpp Definitions/Response.cpp ConfigTokens.cpp main.cpp 
